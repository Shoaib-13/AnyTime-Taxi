...
<html>
    <head>
        <title>Easy Cab Fare List</title>
                        ...
                        if (mysql_num_rows($result) > 0) {
                            while ($row = mysql_fetch_array($result)) {
                                ...
                                <tr>
                                   ...
                                   <td class="grid_label" align="center"><a href="edit_fare.php?id=<?php echo $row ['id']; ?>">Edit</a></td>                            
                                    <td class="grid_label" align="center"><a href="fare_list.php?id=<?php echo $row ['id']; ?>" onclick="return deleteProperties()">Delete</a></td>                            
                                    </td>                            
